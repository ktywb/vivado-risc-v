...
class PartitionCommandRouterIO()(implicit val p: Parameters) extends Bundle {
  ...
  val partition_num = Output(UInt(PartitionConsts.HashWidth.W))       
...
class PartitionCommandRouter(cmd_queue_depth: Int)(implicit p: Parameters)
  ...
  /* ====== Memloader interface : tuple_length_loader ====== */
  ...
  /* ====== Memloader interface : key_info_loader ====== */
  ...
  /* ====== MemWriter32 interface : cache_line_writer ====== */
