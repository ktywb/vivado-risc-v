...
# Add any additional Verilog files (e.g., generated by RoCC accelerators)
if {[info exists additional_verilog_files]} {
    foreach vfile $additional_verilog_files {
        lappend files $vfile
    }
}
...
set file_obj [get_files -of_objects $source_fileset [list "*/*.sv"]]
