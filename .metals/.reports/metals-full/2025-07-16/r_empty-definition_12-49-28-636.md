error id: file://<WORKSPACE>/src/main/scala/rocket.scala:`<none>`.
file://<WORKSPACE>/src/main/scala/rocket.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -Chisel.WithSystemBusWidth_My#
	 -freechips/rocketchip/diplomacy/WithSystemBusWidth_My#
	 -freechips/rocketchip/subsystem/WithSystemBusWidth_My#
	 -freechips/rocketchip/devices/tilelink/WithSystemBusWidth_My#
	 -freechips/rocketchip/system/WithSystemBusWidth_My#
	 -partitionacc/WithSystemBusWidth_My#
	 -WithSystemBusWidth_My#
	 -scala/Predef.WithSystemBusWidth_My#
offset: 4652
uri: file://<WORKSPACE>/src/main/scala/rocket.scala
text:
```scala
package Vivado
...
class PartitionBaseConfig extends Config(
  // new WithZstdCompressor ++
  new WithPartitionAccel ++
  // new WithSystemBusWidth_My(512) ++ 
  ...
  // ) ++
  // new WithInclusiveCache ++
  new Wi@@thSystemBusWidth_My(64) ++  // 减少总线宽度从512到64位
  new WithInclusiveCache(
    nWays = 4,                     // 减少路数从8到4  
    capacityKB = 128,              // 减少缓存大小从512KB到128KB
    writeBytes = 8,                // 保持写字节数
    subBankingFactor = 2           // 减少子存储体因子从4到2
  ) ++
...
class Rocket64b1TEST extends Config(
  new WithNBreakpoints(8) ++
  new WithNBigCores(1)    ++
  new RocketBaseConfig)
