error id: file://<WORKSPACE>/generators/partition-acc/src/main/scala/CommandRouter.scala:partitionacc/`<import>`.
file://<WORKSPACE>/generators/partition-acc/src/main/scala/CommandRouter.scala
empty definition using pc, found symbol in pc: partitionacc/`<import>`.
