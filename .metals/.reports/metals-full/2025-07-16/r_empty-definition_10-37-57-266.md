error id: file://<WORKSPACE>/generators/rocc-acc-utils/src/main/scala/roccaccutils/L2MemHelper.scala:`<none>`.
file://<WORKSPACE>/generators/rocc-acc-utils/src/main/scala/roccaccutils/L2MemHelper.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -chisel3/tags_for_issue_Q/io/enq/valid.
	 -chisel3/tags_for_issue_Q/io/enq/valid#
	 -chisel3/tags_for_issue_Q/io/enq/valid().
	 -chisel3/util/tags_for_issue_Q/io/enq/valid.
	 -chisel3/util/tags_for_issue_Q/io/enq/valid#
	 -chisel3/util/tags_for_issue_Q/io/enq/valid().
	 -freechips/rocketchip/diplomacy/tags_for_issue_Q/io/enq/valid.
	 -freechips/rocketchip/diplomacy/tags_for_issue_Q/io/enq/valid#
	 -freechips/rocketchip/diplomacy/tags_for_issue_Q/io/enq/valid().
	 -freechips/rocketchip/tilelink/tags_for_issue_Q/io/enq/valid.
	 -freechips/rocketchip/tilelink/tags_for_issue_Q/io/enq/valid#
	 -freechips/rocketchip/tilelink/tags_for_issue_Q/io/enq/valid().
	 -roccaccutils/logger/tags_for_issue_Q/io/enq/valid.
	 -roccaccutils/logger/tags_for_issue_Q/io/enq/valid#
	 -roccaccutils/logger/tags_for_issue_Q/io/enq/valid().
	 -tags_for_issue_Q/io/enq/valid.
	 -tags_for_issue_Q/io/enq/valid#
	 -tags_for_issue_Q/io/enq/valid().
	 -scala/Predef.tags_for_issue_Q.io.enq.valid.
	 -scala/Predef.tags_for_issue_Q.io.enq.valid#
	 -scala/Predef.tags_for_issue_Q.io.enq.valid().
offset: 9427
uri: file://<WORKSPACE>/generators/rocc-acc-utils/src/main/scala/roccaccutils/L2MemHelper.scala
text:
```scala
...
class L2MemHelperModule(outer: L2MemHelper, tlbConfig: TLBConfig, printInfo: String = "", queueRequests: Boolean = true, queueResponses: Boolean = true, printWriteBytes: Boolean = false, logger: Logger = DefaultLogger, busBits: Int = 256)(implicit p: Parameters) extends LazyModuleImp(outer)
  ...
  when (fire_actual_mem_resp.fire(tags_for_issue_Q.io.enq.ready)) {
    tags_for_issue_Q.io.enq.val@@id := true.B
