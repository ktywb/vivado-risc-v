error id: file://<WORKSPACE>/generators/partition-acc/src/main/scala/Partition.scala:`<none>`.
file://<WORKSPACE>/generators/partition-acc/src/main/scala/Partition.scala
...
offset: 9904
uri: file://<WORKSPACE>/generators/partition-acc/src/main/scala/Partition.scala
text:
```scala
...
class Partition(implicit val p: Parameters, val hp: L2MemHelperParams)
  ...
  // cache_line_stream
  val cache_line_load_queue = Module(new Queue(new LiteralChunk, 131072))
  ...
  // tuple_length_stream
  val tuple_length_load_queue = Module(new Queue(new LiteralChunk, 131072))
  ...
  // key_info_stream
  val key_info_load_queue = Module(new Queue(new LiteralChunk, 131072))
  ...
  when(
    partition.io.in_tuple_length_valid & partition.io.in_tuple_length_ready
  ) {
    PartitionLogger.accelLogInfo(
